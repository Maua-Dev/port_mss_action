...
class Test_CreateActionPresenter:
    def test_create_action_presenter(self):
        event = {
            ...
            "body": '{"owner_ra":"17033730","start_date":1634526000000,"action_id":"82fc","title":"Teste","description":"Apenas um teste","end_date":1634533200000, "duration":7200000, "project_code":"MF","associated_members_ra":["19017310"],"stack_tags":["BACKEND"],"action_type_tags":["CODE"]}',
            "pathParameters": None,
        ...
        expected = {'action': {'owner_ra': '17033730', 'start_date': 1634526000000, 'action_id': '82fc', 'title': 'Teste', 'description' : 'Apenas um teste', 'end_date' : 1634533200000, 'duration' : 7200000,'project_code': 'MF', 'associated_members_ra': ['19017310'], 'stack_tags': ['BACKEND'], 'action_type_tags': ['CODE']}, 'message': 'the action was created'}
    ...
    def test_create_action_presenter_entity_error(self):
        event = {
            ...
            "body": '{"owner_ra":"123","start_date":1634526000000,"action_id":"82fc","title":"Teste","end_date":1634533200000, "description":"Apenas um teste","duration":7200000, "project_code":"MF","associated_members_ra":["19017310"],"stack_tags":["BACKEND"],"action_type_tags":["CODE"]}',
            "pathParameters": None,
            "isBase64Encoded": None,
            "stageVariables": None
        }
