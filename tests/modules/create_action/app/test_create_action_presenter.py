...
class Test_CreateActionPresenter:
    ...
    def test_create_action_presenter_owner_ra_not_found(self):
        event = {
            ...
            "body": '{"owner_ra":"12345678","start_date":1634526000000,"action_id":"82bc","title":"Teste","end_date":1634533200000, "duration":7200000, "project_code":"MF","associated_members_ra":["19017310"],"stack_tags":["BACKEND"],"action_type_tags":["CODE"]}',
            "pathParameters": None,
            "isBase64Encoded": None,
            "stageVariables": None
        }
    ...
    def test_create_action_presenter_associated_ra_not_found(self):
        event = {
            ...
            "body": '{"owner_ra":"17033730","start_date":1634526000000,"action_id":"82ab","title":"Teste","end_date":1634533200000, "duration":7200000, "project_code":"MF","associated_members_ra":["12345678"],"stack_tags":["BACKEND"],"action_type_tags":["CODE"]}',
            "pathParameters": None,
            "isBase64Encoded": None,
            "stageVariables": None
        }
