...
class Test_CreateActionViewmodel:
    def test_create_action_viewmodel(self):
        ...
        action = Action(owner_ra='17033730', start_date=1634526000000, duration=2*60*60*1000, action_id='82fc', story_id=100, associated_members_ra=['19017310'], title='Teste', end_date=1634536800000, project_code='MF', stack_tags=[STACK.BACKEND], action_type_tags=[ACTION_TYPE.CODE])
    ...
    def test_create_action_viewmodel_without_tags(self):
        ...
        action = Action(owner_ra='17033730', start_date=1634526000000, duration=2*60*60*1000, action_id='82fc', story_id=100, associated_members_ra=None, title='Teste', end_date=1634536800000, project_code='MF', stack_tags=None, action_type_tags=None)
