...
class Test_CreateActionUsecase:
    ...
    def test_create_action_usecase_owner_ra_not_found(self):
        ...
        action = Action(owner_ra='17033731', start_time=1634526000000, action_id='82fc', associated_members_ra=None, title='Teste', end_time=1634536800000, project_code='MF', stack_tags=[STACK.BACKEND], action_type_tags=[ACTION_TYPE.CODE])
    ...
    def test_create_action_usecase_associated_ra_not_found(self):
        ...
        action = Action(owner_ra='17033730', start_time=1634526000000, action_id='82fc', associated_members_ra=['21017310', '21010758'], title='Teste', end_time=1634536800000, project_code='MF', stack_tags=[STACK.BACKEND], action_type_tags=[ACTION_TYPE.CODE])
