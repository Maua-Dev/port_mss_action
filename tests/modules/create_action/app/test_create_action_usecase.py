...
class Test_CreateActionUsecase:
    def test_create_action_usecase(self):
        ...
        action = Action(owner_ra='17033730', date=1634526000, action_id='82fc', associated_members_ra=None, title='Teste', duration=repo.actions[0].duration, project_code='MF', stack_tags=[STACK.BACKEND], action_type_tags=[ACTION_TYPE.CODE])
    ...
    def test_create_action_usecase_with_associated_members(self):
        ...
        action = Action(owner_ra='17033730', date=1634526000, action_id='82fc', associated_members_ra=['21017310', '21010757'], title='Teste', duration=repo.actions[0].duration, project_code='MF', stack_tags=[STACK.BACKEND], action_type_tags=[ACTION_TYPE.CODE])
    ...
    def test_create_action_usecase_duplicated_action_id(self):
        ...
        action = Action(owner_ra='17033730', date=1634526000, action_id="u1e2", associated_members_ra=None, title='Teste', duration=repo.actions[0].duration, project_code='MF', stack_tags=[STACK.BACKEND], action_type_tags=[ACTION_TYPE.CODE])
    ...
    def test_create_action_usecase_owner_ra_not_found(self):
        ...
        action = Action(owner_ra='17033731', date=1634526000, action_id='82fc', associated_members_ra=None, title='Teste', duration=repo.actions[0].duration, project_code='MF', stack_tags=[STACK.BACKEND], action_type_tags=[ACTION_TYPE.CODE])
