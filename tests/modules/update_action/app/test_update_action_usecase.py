...
class Test_UpdateActionUsecase:
    ...
    def test_update_action_usecase_another_member_forbidden_action(self):
        ...
        with pytest.raises(ForbiddenAction):
            action = usecase(action_id=repo.actions[0].action_id, user_id=repo_member.members[2].user_id, new_start_date=1634526000000, new_story_id=100, new_title='Teste', new_end_date=1634536800000, new_project_code='MF', new_stack_tags=[STACK.BACKEND], new_action_type_tag=ACTION_TYPE.CODE)
