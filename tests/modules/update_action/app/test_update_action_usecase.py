...
class Test_UpdateActionUsecase:
    def test_update_action_usecase(self):
        ...
        action = usecase(action_id=repo.actions[0].action_id, new_owner_ra='23017310', new_start_date=1634526000000, new_story_id=100, new_associated_members_ra=['19017311'], new_title='Teste', new_end_date=1634536800000, new_project_code='MF', new_stack_tags=['BACKEND'], new_action_type_tag='CODE')
    ...
    def test_update_action_no_items_found(self):
        ...
        with pytest.raises(NoItemsFound):
            action = usecase(action_id='01538473-35ea-43c5-a823-f278c3fb42f3', new_owner_ra='23017310', new_start_date=1634526000000, new_story_id=100, new_associated_members_ra=['19017311'], new_title='Teste', new_end_date=1634536800000, new_project_code='MF', new_stack_tags=['BACKEND'], new_action_type_tag='CODE')