...
class Test_DownloadProjectsUsecase:
    def test_get_history_usecase(self):
        ...
        actions = usecase(user_id= '93bc6ada-c0d1-7054-66ab-e17414c48ae3')
    ...
    def test_get_history_usecase_with_start_and_end(self):
        ...
        repo_member = MemberRepositoryMock()
        usecase = DownloadProjectsUsecase(repo=repo, repo_member=repo_member)
        actions = usecase(user_id= '93bc6ada-c0d1-7054-66ab-e17414c48ae3', start=1634526000000, end=1676476000000)
    ...
    def test_get_history_usecase_with_exclusive_start_key(self):
        ...
        repo_member = MemberRepositoryMock()
        usecase = DownloadProjectsUsecase(repo=repo, repo_member=repo_member)
        actions = usecase(user_id= '6f5g4h7J-876j-0098-123hb-hgb567fy4hb', start=1634526000000, end=1676476000000, exclusive_start_key={'action_id' : '87d4a661-0752-4ce2-9440-05e752e636fc', 'start_date' : 1634526000000})
        print(actions)
    ...
    def test_get_history_usecase_with_amount(self):
        ...
        repo_member = MemberRepositoryMock()
        usecase = DownloadProjectsUsecase(repo=repo, repo_member=repo_member)
        actions = usecase(user_id= '93bc6ada-c0d1-7054-66ab-e17414c48ae3', amount=10)
    ...
    def test_get_history_usecase_unregistered_user(self):
        ...
        with pytest.raises(UnregisteredUser):
            usecase = DownloadProjectsUsecase(repo=repo, repo_member=repo_member)
            actions = usecase(user_id= 'adbc6ada-c0d1-7054-66ab-e17414c48ae3')
    ...
    def test_get_history_usecase_forbidden_user(self):
        ...
        with pytest.raises(UserNotAllowed):
            usecase = DownloadProjectsUsecase(repo=repo, repo_member=repo_member)
            actions = usecase(user_id= repo_member.members[2].user_id, member_user_id=repo_member.members[0].user_id)

    def test_get_history_usecase_another_user(self):
        repo = ActionRepositoryMock()
        repo_member = MemberRepositoryMock()
        usecase = DownloadProjectsUsecase(repo=repo, repo_member=repo_member)
        actions = usecase(user_id= repo_member.members[0].user_id, member_user_id=repo_member.members[2].user_id)
    ...
    def test_get_history_usecase_amount_less_than_10(self):
        ...
        with pytest.raises(PaginationAmountInvalid):
            usecase = DownloadProjectsUsecase(repo=repo, repo_member=repo_member)
            actions = usecase(user_id= '93bc6ada-c0d1-7054-66ab-e17414c48ae3', amount=5)
    ...
    def test_get_history_usecase_DISCONNECTED_user(self):
        ...
        with pytest.raises(UserNotAllowed):
           actions = usecase(user_id= user.user_id)
    ...
    def test_get_history_usecase_another_user_external(self):
        ...
        actions = usecase(user_id= member1.user_id, member_user_id=repo_member.members[2].user_id)
