...
class Test_UpdateMemberPresenter:
    def test_update_member_presenter(self):
        ...
        assert json.loads(response["body"])["member"]["deactivated_date"] == 100000000000000     

    def test_update_member_presenter_invalid_dactivate_date(self):
        event = {
            "version": "2.0",
            "routeKey": "$default",
            "rawPath": "/my/path",
            ...
            "body": '{"user_id": "93bc6ada-c0d1-7054-66ab-e17414c48ae3","new_name":"Joao Branco","new_email_dev":"jbranco.devmaua@gmail.com","new_role":"HEAD","new_stack":"BACKEND","new_year":3,"new_cellphone":"11991152348","new_course":"ECM","new_active":"ACTIVE","new_deactivated_date":1}',
            "pathParameters": None,
            "isBase64Encoded": None,
            "stageVariables": None
        }
