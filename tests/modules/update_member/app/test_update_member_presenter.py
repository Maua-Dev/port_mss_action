...
class Test_UpdateMemberPresenter:
    def test_update_member_presenter(self):
        event = {
            ...
            "body": '{"new_name":"Joao Branco","new_email_dev":"jbranco.devmaua@gmail.com","new_role":"DIRECTOR","new_stack":"BACKEND","new_year":3,"new_cellphone":"11991152348","new_course":"ECM","new_active":"DISCONNECTED"}',
            "pathParameters": None,
