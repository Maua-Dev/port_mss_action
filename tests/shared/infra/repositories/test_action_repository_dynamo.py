...
class Test_ActionRepositoryDynamo:
    ...
    def test_send_invalid_action_email(self):
        ...
        member_1 = Member(
                ...
                email="gabrielbianconiconi@gmail.com",
                ra="20008228",
                role=ROLE.DEV,
                stack=STACK.INFRA,
                year=1,
                cellphone="11998472553",
                course=COURSE.ECA,
    ...
    def test_get_all_actions_by_project_code(self):
        repo = ActionRepositoryDynamo()
        resp = repo.get_all_actions_by_project_code(project_code="PT", amount=20, start=1644256000000, end=1653756000000, exclusive_start_key={'action_id' : "5f4f13df-e7d3-4a10-9219-197ceae9e3f0", 'start_date' : 1644256000000})
