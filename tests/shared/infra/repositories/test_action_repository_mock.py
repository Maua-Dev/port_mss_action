...
class Test_ActionRepositoryMock:
    def test_create_action(self):
        ...
        action = Action(owner_ra='17033730', start_date=1634526000000, action_id='82fc', story_id=100, duration=2*60*60*1000, associated_members_ra=['12345678'], title='Teste', end_date=1634536800000, project_code='MF', stack_tags=[STACK.BACKEND], action_type_tags=[ACTION_TYPE.CODE])
    ...
    def test_create_action_with_associated_members(self):
        repo = ActionRepositoryMock()
        action = Action(owner_ra='17033730', start_date=1634526000000, action_id='82fc', story_id=100, duration=2*60*60*1000, associated_members_ra=['12345678', '98765432'], title='Teste', end_date=1634536800000, project_code='MF', stack_tags=[STACK.BACKEND], action_type_tags=[ACTION_TYPE.CODE])
