...
class LambdaStack(Construct):
    ...
    def create_lambda_api_gateway_integration(self, module_name: str, method: str, mss_member_api_resource: Resource, environment_variables: dict = {"STAGE": "TEST"}):
        ...
        mss_member_api_resource.add_resource(module_name.replace("_", "-")).add_method(method,
